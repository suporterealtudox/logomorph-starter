 ...
 *
 *  No fim a arte completa entra por cima, encaixada no mesmo lugar: é o
 *  que garante que o último quadro seja idêntico ao arquivo do designer,
 *  sem depender da precisão de cada encaixe.
 *
 *  As medidas estão em porcentagem do palco (o desenho tem 620x620), o
 *  que mantém tudo no lugar em qualquer tamanho de tela. */

type Peca = { nome: string; x: number; y: number; w: number };

/** ordem de entrada e posição final de cada peça */
const PECAS: Peca[] = [
  ...
  { nome: 'nome-5-M', x: 40.968, y: 52.419, w: 14.194 }, // a dourada, com a haste longa
  { nome: 'nome-6-O', x: 54.677, y: 53.226, w: 9.677 },
  { nome: 'nome-7-R', x: 64.032, y: 53.226, w: 9.032 },
  { nome: 'nome-8-P', x: 72.581, y: 53.226, w: 9.032 },
  { nome: 'nome-9-H', x: 80.806, y: 53.226, w: 9.194 },
  { nome: 'registrado', x: 89.032, y: 54.194, w: 5.484 },
  ...
  return (
    <div className="abertura" id="abertura" aria-hidden="true">
      <div className="escudo">
        {/* o disco e os aros: a base onde as peças assentam */}
        ...
        {/* a arte completa, encaixada por cima no fim da montagem */}
        <img className="inteira" src="/img/logomorph-logo.png" alt="" />
      </div>
    </div>
  );
}
